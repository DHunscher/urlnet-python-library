...
def main(which):
    ...
    try:
        ...
        urlnet.log.altfd=open('healiatree.log.txt','w')
    except Exception,e:
        myLog.Write(str(e)+'\n')
        goAhead = False
    try:
        if goAhead:
            if which == 1:
                ...
                net.WritePajekFile('healiatree-quitsmoking','healiatree-quitsmoking')
                net.WriteGuessFile('healiatree-quitsmoking_urls')            # url network
                net.WriteGuessFile('healiatree-quitsmoking_domains',False)      #domain network
                ...
                net.WritePajekFile('healiatree-stopsmoking','healiatree-stopsmoking')
                net.WriteGuessFile('healiatree-stopsmoking_urls')            # url network
                net.WriteGuessFile('healiatree-stopsmoking_domains',False)      #domain network
                ...
                net.WritePajekFile('healia-smokingcessation','healia-smokingcessation')
                net.WriteGuessFile('healia-smokingcessation_urls')            # url network
                net.WriteGuessFile('healia-smokingcessation_domains',False)      #domain network
                ...
                #net.MapFunctionToUrlNetwork(PrintHierarchy,args=sys.stderr)
                #net.MapFunctionToDomainNetwork(PrintHierarchy,args=sys.stderr)
                net.WritePajekFile('healiatree-basic-quitsmoking','healiatree-basic-quitsmoking')
                net.WriteGuessFile('healiatree-basic-quitsmoking_urls')            # url network
                net.WriteGuessFile('healiatree-basic-quitsmoking_domains',False)      #domain network
                ...
                net.WritePajekFile('healiatree-basic-stopsmoking','healiatree-basic-stopsmoking')
                net.WriteGuessFile('healiatree-basic-stopsmoking_urls')            # url network
                net.WriteGuessFile('healiatree-basic-stopsmoking_domains',False)      #domain network
                ...
                net.WritePajekFile('healiatree-basic-smokingcessation','healiatree-basic-smokingcessation')
                net.WriteGuessFile('healiatree-basic-smokingcessation_urls')            # url network
                net.WriteGuessFile('healiatree-basic-smokingcessation_domains',False)      #domain network
...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        if len(sys.argv[0]) > 0:
            ...
            print 'Usage: python healia-stopsmoking-collector.py [number of test to run]'
    else:
        main(int(sys.argv[1]))
    sys.exit(0)

    """
    schtasks /Create /SC DAILY /ST 12:00:00 /TN stopsmoking-collector /TR "c:\Python25\python25.exe c:\docume~1\dalehuns\desktop\blogstuff\healia-stopsmoking-collector.py 1"
    """    
